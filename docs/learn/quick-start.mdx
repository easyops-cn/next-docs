...
In the examples on this page, we will use native HTML elements as bricks for simplicity. But we also provide a built-in brick library, containing lots of custom elements, with decent design, out of the box. Additionally, you can also create your own bricks, a.k.a custom elements.
...
You can also create your own [_provider bricks_](../concepts/provider-bricks.md) if you have complex logical to fetch and process data, which involves pro code.
